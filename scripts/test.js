var template = '{#list}' +
    ...
    '<span class="fa fa-check-square fn-checkbox text-info"></span><div class="fn-newsList-bayI clearfix fn-title-container">'+
...
var template2 = '{#list}' +
    ...
    '<div class="fn-newsTitle-top">'+
    '<h4 class="fn-newsTitle">'+
    '{#if (viocesize >= 1 && viocesize <= 9)}' +
    '<span class="label label-success fn-inlineBlock">原创</span>' +
    '{#elseif (viocesize>=10 && viocesize<=50)}' +
    '<span class="label label-default fn-inlineBlock">转载</span>' +
    '{#/if}' +
    '<span>{title}</span>'+
    '</h4>'+
